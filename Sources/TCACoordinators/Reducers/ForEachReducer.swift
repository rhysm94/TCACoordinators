...
extension Reducer {
  func forEachIndex<ElementState, ElementAction, Element: Reducer>(
    ...
    action toElementAction: AnyCasePath<Action, (id: Int, action: ElementAction)>,
...
>: Reducer {
  ...
  let toElementAction: AnyCasePath<Parent.Action, (id: Int, action: Element.Action)>
  let element: Element
  ...
  init(
    ...
    toElementAction: AnyCasePath<Parent.Action, (id: Int, action: Element.Action)>,
    element: Element,
    file: StaticString,
    fileID: StaticString,
    line: UInt
